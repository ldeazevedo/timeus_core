...
public class Q227_TestOfTheReformer extends Quest
{
	...
	private static L2Npc _olMahumInspector = null;
	private static L2Npc _olMahumPilgrim = null;
	private static L2Npc _olMahumBetrayer = null;
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		else if (event.equalsIgnoreCase("30669-03.htm"))
		{
			...
			if (!_crimsonWerewolf)
			{
				L2Npc crimsonWerewolf = addSpawn(CRIMSON_WEREWOLF, -9382, -89852, -2333, 0, false, 299000, true);
				_crimsonWerewolf = true;
				
				_olMahumPilgrim = addSpawn(OL_MAHUM_PILGRIM, -9382, -89855, -2333, 0, false, 0, true);
				
				((L2Attackable) crimsonWerewolf).addDamageHate(_olMahumPilgrim, 0, 99999);
				crimsonWerewolf.getAI().setIntention(CtrlIntention.ATTACK, _olMahumPilgrim);
				
				startQuestTimer("ol_mahums_despawn", 40000, null, player, true);
		...
		else if (event.equalsIgnoreCase("ol_mahums_despawn"))
		{
			...
			if (st.getInt("cond") == 12 || _timer >= 60)
			{
