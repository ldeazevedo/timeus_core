...
public class Q403_PathToARogue extends Quest
{
	...
	private QuestState debugQuestState = null;
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isPet)
	{
		...
		if (st == null)
		{
			st = checkPlayerState(player, npc, STATE_CREATED);
			// _log.warning("Q403_PathToARogue - ST is null");
		...
		// final int equipedDebugItem = player.getInventory().getPaperdollItemId(Inventory.PAPERDOLL_RHAND);
		...
		{
			_log.warning("No encuentra las armas equipadas.");
			return null;
		}
