...
public class L2AttackableAIScript extends Quest
{
	...
	public String onFactionCall(L2Npc npc, L2Npc caller, L2PcInstance attacker, boolean isPet)
	{
		try
		{
			...
			// Parece que por aca tira el error, vamos a verlo
			final L2Attackable attackable = (L2Attackable) npc;
			L2Character originalAttackTarget = attacker;
			if (isPet)
				originalAttackTarget = attacker.getPet();
	...
	public String onAggro(L2Npc npc, L2PcInstance player, boolean isPet)
	{
		...
		((L2Attackable) npc).addDamageHate(isPet ? player.getPet() == null ? player : player.getPet() : player, 0, 1);
		return null;
	}
