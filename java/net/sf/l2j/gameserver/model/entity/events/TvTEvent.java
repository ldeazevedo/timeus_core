...
public class TvTEvent
{
	...
	public static boolean startParticipation()
	{
		...
		try
		{
			...
			isLow = Rnd.get(100) < 50;
			
			_npcSpawn.setLoc(Config.TVT_EVENT_PARTICIPATION_NPC_COORDINATES[0], Config.TVT_EVENT_PARTICIPATION_NPC_COORDINATES[1], Config.TVT_EVENT_PARTICIPATION_NPC_COORDINATES[2], 15);
	...
	public static synchronized boolean addParticipant(L2PcInstance playerInstance)
	{
		...
		if (isLow && playerInstance.getLevel() > 65)
			return false;
		else if (!isLow && playerInstance.getLevel() < 65)
			return false;
