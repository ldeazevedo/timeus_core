...
public class Die extends L2GameServerPacket
{
	...
	public Die(L2Character cha)
	{
		...
		if (cha instanceof L2PcInstance)
		{
			_canTeleport = !((TvTEvent.isStarted() && TvTEvent.isPlayerParticipant(_charObjId))) || EventManager.getInstance().isInEvent((L2PcInstance) cha);
		}
		// _canTeleport = !(cha instanceof L2PcInstance && TvTEvent.isStarted() && TvTEvent.isPlayerParticipant(_charObjId) && RandomFight.isInRandomFight((L2PcInstance)cha));
	}
