...
public class EnterWorld extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			activeChar.sendMessage("Sabias que tenes GK gratis hasta lvl 40? Probalo!");
			activeChar.sendMessage("Tambien tenes chat global, para que todos puedan comunicarse.");
			activeChar.sendMessage("Los buffs de Newbie son hasta lvl 61, con Berzeker Spirit agregado!");
			GmListTable.broadcastMessageToGMs("Account name: " + activeChar.getAccountName() + " || Player name: " + activeChar.getName());
		}
